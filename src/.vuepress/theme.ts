...
export default hopeTheme(
  ...
  blog: {
    ...
    medias: {
      ...
      Zhihu: `?account=JasonLeeYa&url=${encodeURIComponent('https://www.zhihu.com/people/jasonleeya')}`,
      Steam: `?account=JasonLee&url=${encodeURIComponent('https://steamcommunity.com/profiles/76561198961789123/')}`,
    },
  },
  ...
  plugins: {
    ...
    comment: {
      ...
      provider: "Waline",
      serverURL: "https://blog-kowxnwntg-jasonleeya.vercel.app",
    },
